...
function Packet() {
	...
	Packet.prototype.newPV=function() {
		...
		this.PV.innerHTML="<header id= 'header"+this.id+"' class='col-xs-12'> <div class='col-xs-3 col-xs-offset-4'>Packet</div> <button class='col-xs-2 col-xs-offset-3' id='remove"+this.id+"' class='remove' onclick='removeElement(this,event)'>X</button></header>"
